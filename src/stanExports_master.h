...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(243, 241, "end", "model_master");
    return reader;
}
            ...
            if (as_bool(inc)) {
                ...
                if (as_bool(meas_err)) {
                    ...
                    stan::model::assign(eq_lhs, 
                                stan::model::cons_list(stan::model::index_uni(1), stan::model::nil_index_list()), 
                                subtract(add((3.89 + (0.4320 * stan::math::log(9.8))), multiply(0.5862, stan::math::log(get_base1(Sact, 1, "Sact", 1)))), multiply(0.7282, stan::math::log(get_base1(Wact, 1, "Wact", 1)))), 
                                "assigning variable eq_lhs");
                    current_statement_begin__ = 199;
                    stan::model::assign(eq_rhs, 
                                stan::model::cons_list(stan::model::index_uni(1), stan::model::nil_index_list()), 
                                subtract(add(get_base1(logk_man, 1, "logk_man", 1), multiply(0.3084, ragged_col(get_base1(logn, 1, "logn", 1), hasdat, pstream__))), multiply(0.7282, get_base1(logA_man, 1, "logA_man", 1))), 
                    ...
                    stan::model::assign(eq_lhs, 
                                stan::model::cons_list(stan::model::index_uni(1), stan::model::nil_index_list()), 
                                subtract(add((3.89 + (0.4320 * stan::math::log(9.8))), multiply(0.5862, logSobs_man)), multiply(0.7282, logWobs_man)), 
                                "assigning variable eq_lhs");
